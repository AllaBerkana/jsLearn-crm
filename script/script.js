...
/*
    1. Нажимаем на кнопку Добавить товар
    2. Открыватеся модальное окно с формой

    3. Заполняем форму и отправляем данные на сервер:
    3.1 Получаем значения формы через формДату
    3.2 Извлекаем эти данные из объекта и вставляем в строку таблицы
    3.3 Строку вставляем в тело таблицы
    3.4 Данные из формы отправляются в массив данных

    4. На основе полученных данных производятся расчеты:
    4.1 Номер по-порядку каждой строки (и потом вставить в строку)
    4.2 Общая сумма товаров (вставить на страницу)
    4.3 Новый айди (в строку)

    5. Массив с данными должен постоянно обновляться:
    5.1. Обновиться при удалении товара
    5.2 Обновиться при добавлении товара

    6. Закрытие модального окна  и его очистка по:
    6.1 Клику на кнопку
    6.2 Клику на оверлей
    6.3 Отправке формы

    7. Удаление товара по клику на кнопку "Удалить"
    7.1 Удаляется из верстки строка
    7.2 Удалить элемент из массива данных
    7.3 Обновить массив данных
    7.4 Пересчитать номер по-порядкукаждого товара в таблице

    8. Получить сумму всех товаров:
    8.1 Перебрать актуальный массив данных
    8.2 Получить из массива общую сумму каждого товара
    8.3. Посчитать сумму всех товаров
    8.4 Вывести на страницу
